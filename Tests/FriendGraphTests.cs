...
namespace DailyCodingProblem1091.Test
{
    public class FriendGraphTests
    {
         ...
         */
        [Test]
        public void GivenFriendshipAdjacentList_WhenGetFriendGroups_ThenReturnAnAdjacentListWithTheFriendGroups()
        {
            var sut = new FriendGraph(DataMother.GetGmailGrapthData());

            var result = sut.GetFriendGrups();
            ...
            Assert.That(result.AllElementsEquals(expectedResult));
        }
    }
}
